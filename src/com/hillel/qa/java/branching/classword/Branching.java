...
public class Branching {
    ...
    public static void main(String[] args) {
       ...
       */
        ...
        далі ми бачемо саму умову age == 18, після умови ми бачимо команду System.out.println.
       ...
       /* int age = 18; // Зміна яка зберігає вік
        ...
        /*Завдання 2:
         Якщо людині менше 18 років, ми надрукуємо "Ви ще дитина!",
         Все інше "Ви дорослі!"
         -----------------------------------------------------------------
         Як ви бачите у прикладі з'явилося слово else, це можно розуміти так,
        ...
        if (age < 18){
         ...
         А ще else if можно використовувати скільки завгодно.
         */
        ...
        switch (weekDay) {
            ...
            case 3:
                ...
                break;
            case 4:
                System.out.println("Сьогодні Четверг!");
                break;
            case 5:
                System.out.println("Сьогодні Пятниця!");
                break;
            case 6:
                System.out.println("Сьогодні Суббота!");
                break;
            case 7:
