...
public class Variables {
     ...
     *
     * <b style="color: #ffd700">Змінні</b> — це такє місце, де зберігаються дані. У Java всі дані зберігаються у змінних.
     * За своїм призначенням змінна дуже схожа на коробку, в яку можно покласти щось, та дістати.
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         скільки потрібно, не побоючись збільшити її обсяг. Найчастіше використовуються дві косі риси //.
         Другий варіант це блоки коментарів роздільниками /*, як в нашому прикладі. А тепер перейдемо до зміних
         */

        //Cтворення або оголошення зміної
        ...
        //Присвоювання або ініціалізація зміної
