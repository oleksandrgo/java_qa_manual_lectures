 ...
 * <h1>Вітаю усіх. Ми з вами розпочинаємо знайомство з мовую JAVA. В рамках заннять ми з вами розберемо</h1>
 ...
 *     <li>Розгалуження</li>
 *      <li>Цикли</li>
 *      <li>Понятя клас, метод </li>
 *  </ol>
 *  <p style="font-size:12px">
 *      Як ви можете бачити наша програма складається с класу <b style="color: #ffd700">Introduction</b>
 *      в якій міститься метод <b style="color: #ffd700">main.</b> Зверніть вашу увагу на те що класс пишеться
...
public class Introduction {
     ...
     * Взагалі можно сказати що метод складається з команд. Можна навіть сказати, що метод — це група команд.
    ...
    public static void main(String[] args) {
        ...
        Важливо розуміти що регістр в JAVA має значеня, system.out.println("Hello world");
